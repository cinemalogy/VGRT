<%-- 
    Document   : file_upload2
    Created on : May 25, 2016, 11:59:36 AM
    Author     : java4
--%>

<%@page import="pack.RSAupload"%>
        ...
        <div class="container">
            <div class="row">
                <div class="box" style="height: 400px;">
                    ...
                    <form action="RSAupload" method="Post" id="sendemail"  enctype="multipart/form-data" style="margin-left: 450px;">
