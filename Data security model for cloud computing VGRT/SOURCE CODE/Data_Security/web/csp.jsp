<%-- 
    Document   : csp
    Created on : May 19, 2016, 5:16:38 PM
    Author     : java4
--%>
<!DOCTYPE html>
<html lang="en">
...
<style>
  ...
  height: 100vh;
  background: url("img/cs1.jpg") 50% fixed;
                    ...
                    <br><div class="menu">
						<ul class="nav nav-tabs" role="tablist"><br><br>
							...
							<li role="presentation"><a href="client.jsp" >Client</a></li>
                                                          <li role="presentation"><a href="csp.jsp" class="active">CSP</a></li>
			...
			<div id="carousel-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">						
                                           ...
                                           <br><br><br><form class="login" action="loginaction.jsp">
    <p class="title">CSP Log in</p>
...
<!--    <input type="password" placeholder="Secret Key" name="key"/>
    ...
    <button>
      <i class="spinner"></i>
      <span class="state">CSP Log in</span>
    </button>
  </form>
