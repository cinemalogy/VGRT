<%-- 
    Document   : auditor
    Created on : May 19, 2016, 5:30:24 PM
    Author     : java4
--%>
<!DOCTYPE html>
<html lang="en">
...
<style>
  ...
  height: 100vh;
  background: url("img/aud1.jpg") 50% fixed;
                ...
                <div class="navbar-collapse collapse">							
                    <br><div class="menu">
						<ul class="nav nav-tabs" role="tablist"><br><br>
							...
							<li role="presentation"><a href="auditor.jsp" class="active">Auditor</a></li>
				...
				<div class="carousel-inner">
					<div class="item active">						
                                            ...
                                            <br><br><br><form class="login" action="loginaction.jsp">
                                                <p class="title">Auditor Log in</p>
