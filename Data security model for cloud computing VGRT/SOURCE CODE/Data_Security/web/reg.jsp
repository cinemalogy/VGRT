...
<html lang="en">
    ...
    <body background="img\re1.jpg" onload="setMaxDate()">
        <%
                            ...
                            <div class="container">
                                ...
                                <div  class="form" >
                                    ...
                                    <form id="contactform" action="loginaction.jsp" method="get"> 
                                        ...
                                        <p class="contact"><label for="name"></label></p> 
                                        <input id="inputDate" name="date" placeholder="Date Of Birth" required="" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"  type="date"> 
