<%-- 
    Document   : csp_c_details
    Created on : May 20, 2016, 6:17:38 PM
    Author     : java4
--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                       <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="csp_c_details.jsp">Client Authorized</a>
                        </li>
                        <li>
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        ...
                        <table border="1" style="text-align: center;margin-left: 40px">
                            <tr>
                                ...
                                <th style="text-align: center">Authorized to Client</th>
                         ...
                         <td> <a href="csp_mail.jsp?<%=rs.getString("id")%>"><font style="color: green">Send</a></font> </td>
