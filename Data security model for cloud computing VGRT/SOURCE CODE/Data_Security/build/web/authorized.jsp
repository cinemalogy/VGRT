<%-- 
    Document   : authorized
    Created on : May 20, 2016, 12:10:11 PM
    Author     : java4
--%>
...
<html lang="en">
    ...
    <body>
       <%
        ...
        %>
        <script>alert('User Nsme Password Send to User Mail ID');</script>
        <%
            }
        %>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="csp_c_details.jsp">Client Details</a>
                        </li>
                        <li>
                            <a href="authorized.jsp">Client Authorized</a>
                        </li>
                        <li>
                            <a href="csp_file.jsp">File Details</a>
                        </li>
                        <li>
            ...
            <div class="row">
                <div class="box" style="height: 400px;">
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        <center><h3>CSP Request Details</h3></center><br />
                        <table border="1" style="text-align: center;margin-left: 40px">
                            <tr>
                                ...
                                <th style="text-align: center">Response to Client</th>
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from reg where request='Decrypted'");
                                        while(rs.next())
                                        ...
                                        <td><%=rs.getString("country")%></td> 
                                         <td> <a ><font style="color: green">Decrypted</a></font> </td>
                         <td> <a href="?<%=rs.getString("id")%>"><font style="color: green">Send</a></font> </td>
