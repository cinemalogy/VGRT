<%-- 
    Document   : otpass
    Created on : May 19, 2016, 3:33:38 PM
    Author     : java4
--%>
            ...
            <div class="row">
                <div class="box" style="height: 400px;">
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        ...
                        <center><form class="login" action="loginaction.jsp" method="post">
    <p class="title">Give a Secret Password</p><br>

    <input type="password" placeholder="One Time Password" name="otp"/>
