<%-- 
    Document   : csp_req
    Created on : May 20, 2016, 12:31:11 PM
    Author     : java4
--%>
...
<html lang="en">
    ...
    <body>
       <%
        ...
        %>
        <script>alert('Password Decrypted Successfully');</script>
        <%
            }
        %>
                    ...
                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">
                        ...
                        <table border="1" style="text-align: center;margin-left: 40px">
                            <tr>
                                ...
                                <!--<th style="text-align: center">Response to CSP</th>-->
                         ...
                         <!--<td> <a href="a_req_up.jsp?<%=rs.getString("id")%>"><font style="color: green">Send</a></font> </td>-->
