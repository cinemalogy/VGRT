...
//                                 	
                            ...
                            %>
                                ...
                                <td> <a href="view_file.jsp?<%=rs.getString("fileid")%>"><font style="color: green">view</a></font> </td>  
                                <td> <a href="download?<%=rs.getString("fileid")%>"><font style="color: green">Download</a></font> </td>   
                                        <tr />
