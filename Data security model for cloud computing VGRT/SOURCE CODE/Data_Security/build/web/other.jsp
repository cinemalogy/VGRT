<%-- 
    Document   : other
    Created on : May 21, 2016, 12:02:27 PM
    Author     : java4
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="box" style="height: 400px;">
                   <label style="margin-left: 10px;font-size: 18px;color: red">Your Already Upload This File on the Drive HQ</label><br />
                            ...
                            <ul style="margin-left: 350px;font-size: 18px;color: #0000cc"><br />
                                 <label style="margin-left: 10px;font-size: 18px;color: red">Suggestions:</label><br><br>
                                     <li>Please Try Uploading Different File </li><br>
                                     <!--<li>Try Again.</li>-->
                            </ul>
                </div>
            </div>
