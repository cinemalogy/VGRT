<%-- 
    Document   : c_profile
    Created on : May 19, 2016, 5:22:38 PM
    Author     : java4
--%>
            ...
            <div class="row">
                <div class="box" style="height: 400px;">
                    <%
                        ...
                        System.out.println("User email in bprofile " + cname);
                      
                        try {
                            con = DbConnection.getConnection();
                            st = con.createStatement();
                            rs = st.executeQuery("select * from reg where Name ='" + cname + "'");
                            if (rs.next()) {%>
                    <!--To do you work-->
                    <div style="border: 1px solid white;height: 360px;border-top-width: 20px;border-bottom-width: 10px">
                        ...
                        <fieldset style="margin-left: 380px">
                            <label>UID</label><input type="text" readonly="" value="<%=rs.getString("id")%>" style="margin-left: 100px;width: 250px;"/><br /><br />
                            ...
                            <label>DOB</label><input type="text" readonly="" value="<%=rs.getString("dob")%>" style="margin-left: 90px;width: 250px;"/><br /><br />
                            <label>Cell</label><input type="text" readonly="" value="<%=rs.getString("phone")%>" style="margin-left: 92px;width: 250px;"/><br /><br />
                        </fieldset>
                    </div>
                    <%}
                        } catch (Exception ex) {
